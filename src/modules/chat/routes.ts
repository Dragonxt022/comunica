...
router.post('/conversas/:id/pin',       isAuthenticated, Chat.togglePin);
router.post('/conversas/:id/categoria', isAuthenticated, Chat.definirCategoria);
router.post('/conversas/:id/avatar',    isAuthenticated, upload.single('avatar'), Chat.atualizarAvatarGrupo);
router.delete('/conversas/:id/mensagens', isAuthenticated, Chat.limparConversa);
router.delete('/conversas/:id',           isAuthenticated, Chat.apagarConversa);
router.delete('/mensagens/:msgId',        isAuthenticated, Chat.excluirMensagem);
router.get('/categorias',          isAuthenticated, Chat.listarCategorias);
router.post('/categorias',         isAuthenticated, Chat.criarCategoria);
router.delete('/categorias/:catId',isAuthenticated, Chat.excluirCategoria);
router.post('/upload',             isAuthenticated, upload.single('file'), Chat.uploadArquivo);
router.get('/keys/me',             isAuthenticated, Chat.getMyKeys);
